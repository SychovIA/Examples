...
public class CreatePanel extends JPanel{
	...
	CreatePanel(){
		...
		addButton.addActionListener(e->{
			DataBase.addCandidat(surnameField.getText(), nameField.getText());
		...
		delateButton.addActionListener(e1->{
			DataBase.removeCandidat(list.getSelectedValue());
			candidats = DataBase.getCandidats();
			list.updateUI();
		});
		...
		createVoting.addActionListener(e2->{
			 ...
			 */
			DataBase.setDate(begingPanel.getDate(), endPanel.getDate());
		...
		abortVoiting.addActionListener(e3 ->{
			...
			DataBase.delateDate(); // удаление из БД даты голосования
			DataBase.resetIsVote(); //обнуление "проголосовал" в БД
			DataBase.resetVote(); // сброс всех голосов кандидатов до 0.
