...
public class RegistrationFrame extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (!Arrays.equals(passwordField.getPassword(), repeatPasswordField.getPassword())){
			...
			// Регистрация в БД
		int i = Client.registration(surnameField.getText(), nameField.getText(), loginField.getText(), passwordField.getPassword()); //регистрация
		
		if (i == Client.OK){
			JOptionPane.showMessageDialog(null, "Вы успешно зарегистрированы.", "Регистрация", JOptionPane.INFORMATION_MESSAGE);
			dispose(); //при успешной регистрации окно закрывается
		}else if(i == Client.FALSE){
