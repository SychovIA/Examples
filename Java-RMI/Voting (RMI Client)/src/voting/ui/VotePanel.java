	...
	VotePanel(){
		...
		voteButton.addActionListener(e -> {
			...
			if(!list.isSelectionEmpty()){
				...
				int i = DataBase.voted(DataBase.getCurrentUser().getLogin(), list.getSelectedValue());
				if(i == DataBase.OK)
					...
					JOptionPane.showMessageDialog(null, "Вы уже проголосовали", "Голосование", JOptionPane.INFORMATION_MESSAGE);
