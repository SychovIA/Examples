...
public class EnterFrame extends JFrame{
	...
	okButton.addActionListener( e ->{
		...
		int i = DataBase.enter(loginField.getText(), passwordField.getPassword()); //запрос на вход
		// проверка данных пользователя
		// вход будет считаться успешным если данные пользователя не пусты.
		if(DataBase.getCurrentUser() !=null && i == DataBase.OK){
			String category = DataBase.getCurrentUser().getCategory();
			switch (category) {
